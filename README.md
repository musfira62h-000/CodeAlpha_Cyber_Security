...
## Task 1 Ã¢â‚¬â€ Basic Network Sniffer
...
- `task1_network_sniffer.py` / Task 1 report (local) Ã¢â‚¬â€ Task 1 report with setup, screenshots, and analysis  
- [`task1_network_sniffer.py`](./task1_network_sniffer.py) Ã¢â‚¬â€ Scapy network sniffer script  
...
## Task 2 Ã¢â‚¬â€ Phishing Awareness Training
...
- [`CodeAlpha_Task2_Phishing_Awareness_Training.pptx`](./CodeAlpha_Task2_Phishing_Awareness_Training.pptx) Ã¢â‚¬â€ phishing awareness training presentation (20 slides)

---

## Task 4 Ã¢â‚¬â€ Network Intrusion Detection System (NIDS)
...
- [`CodeAlpha_Task4_Network_IDS_.docx`](./CodeAlpha_Task4_Network_IDS_.docx) â€” full Task 4 Snort NIDS report with setup, rules, attacks, and screenshots
